...
export const handler = async (event) => {
  ...
  try {
    ...
    console.error('error in ch-analytic-chat-message-listing-post ' + random10DigitNumber, e);

    const message = {
        Subject: 'Error - ch-analytic-chat-message-listing-post- ' + random10DigitNumber,
        Message: `Error in ch-analytic-chat-message-listing-post ${e.message}\n\nStack trace:\n${e.stack}`,
