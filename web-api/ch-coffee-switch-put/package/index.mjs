...
export const handler = async (event) => {
    ...
    try {
        ...
        //     Statement: `SELECT * FROM "${tableName}" WHERE PK = 'ENUM' AND type = 'COFFEE' `
        // }));
        ...
        let sql = `UPDATE "${tableName}" SET enum_values = '${body.claimStatus}' WHERE PK = 'ENUM' AND SK = 'COFFEE'`;
        ...
        console.error('error in ch-coffee-switch-put ' + random10DigitNumber, e);
    
        const message = {
            Subject: 'Honda Cardano Error - ch-coffee-switch-put - ' + random10DigitNumber,
            Message: `Error in ch-coffee-switch-put: ${e.message}\n\nStack trace:\n${e.stack}`,
