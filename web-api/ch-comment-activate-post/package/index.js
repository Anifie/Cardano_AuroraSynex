...
export const handler = async (event) => {
    ...
    try {
        ...
        sql = `update "${tableName}" set status = 'ACTIVE' , modified_date = '${new Date().toISOString()}' where PK = '${comment.PK}' and SK = '${comment.SK}'`;
        ...
        console.error('error in ch-comment-activate-post ' + random10DigitNumber, e);
        
        const message = {
            Subject: 'Honda Cardano Error - ch-comment-activate-post - ' + random10DigitNumber,
            Message: `Error in ch-comment-activate-post: ${e.message}\n\nStack trace:\n${e.stack}`,
