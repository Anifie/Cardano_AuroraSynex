...
export const handler = async (event) => {
    ...
    try {
        ...
        console.error('error in ch-nft-queue-get ' + random10DigitNumber, e);
        
        const message = {
            Subject: 'Honda Cardano Error - ch-nft-queue-get - ' + random10DigitNumber,
            Message: `Error in ch-nft-queue-get: ${e.message}\n\nStack trace:\n${e.stack}`,
