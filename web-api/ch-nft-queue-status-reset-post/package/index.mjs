...
export const handler = async (event) => {
    ...
    try {
        ...
        console.error('error in ch-nft-queue-status-reset-post ' + random10DigitNumber, e);
        
        const message = {
            Subject: 'Honda Cardano Error - ch-nft-queue-status-reset-post - ' + random10DigitNumber,
            Message: `Error in ch-nft-queue-reset-status-post: ${e.message}\n\nStack trace:\n${e.stack}`,
