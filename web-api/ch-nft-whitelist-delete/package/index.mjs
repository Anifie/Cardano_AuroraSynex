...
export const handler = async (event) => {
    ...
    try {
        ...
        sql = `delete from "${tableName}" where PK = 'WHITELIST#${body.whitelistId}' and SK = 'MEMBER#${body.memberId}'`;
        ...
        console.log("delete whitelist", dbTxResult);
        ...
        console.error('error in ch-nft-whitelist-delete ' + random10DigitNumber, e);
        
        const message = {
            Subject: 'Honda Cardano Error - ch-nft-whitelist-delete - ' + random10DigitNumber,
            Message: `Error in ch-nft-whitelist-delete: ${e.message}\n\nStack trace:\n${e.stack}`,
